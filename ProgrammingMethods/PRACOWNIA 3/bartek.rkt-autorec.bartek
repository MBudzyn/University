...
(define (gate-not wirewyjscie wire2)
     (wire-on-change! wire2 (cons (lambda () (wire-set! wirewyjscie (not (wire-value wire2)))) 1)))
...
(define (flip-flop out clk data)
  (define sim4 (wire-symulacja data))
  (define w1  (make-wire sim4))
  (define w2  (make-wire sim4))
