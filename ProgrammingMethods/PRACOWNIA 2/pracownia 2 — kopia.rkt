...
(define (wire-on-change! wire1 akcja)
  (akcja)
  (set-wire-list_of_actions! wire1 (append (wire-list_of_actions wire1) (list akcja)))) ; dodanie akcji z wywolaniem bez sprawdzenia czy dziala
...
(define (gate-and wirewyjscie wire2 wire3)
  (if
     (and
        (eq? (wire-symulacja wirewyjscie) (wire-symulacja wire2))
        (eq? (wire-symulacja wirewyjscie) (wire-symulacja wire3)))
    ((wire-on-change! wire2 (lambda () (wire-set! wirewyjscie (and (wire-value wire2) (wire-value wire3)))))
     (wire-on-change! wire3 (lambda () (wire-set! wirewyjscie (and (wire-value wire2) (wire-value wire3))))))
     (error "rozne symulacje"))); brak obslugi roznych kabli (wywalania errora)
...
(define (gate-nand wirewyjscie wire2 wire3)
  (if
     (and
        (eq? (wire-symulacja wirewyjscie) (wire-symulacja wire2))
        (eq? (wire-symulacja wirewyjscie) (wire-symulacja wire3)))
    ((wire-on-change! wire2 (lambda () (wire-set! wirewyjscie (nand (wire-value wire2) (wire-value wire3)))))
     (wire-on-change! wire3 (lambda () (wire-set! wirewyjscie (nand (wire-value wire2) (wire-value wire3))))))
     (error "rozne symulacje")))
...
((car (wire-list_of_actions wire2)))
