...
(define example-row5 (list "4443" "45" 43))
(define example-row4 '())
...
;(pretty-print (table-insert example-row pusta))
;(pretty-print (table-insert example-row5 polpusta))
...
(define o1 (table-rename 'area 'capitol cities))
(define o2 (table-rename 'capitol 'capitol1 cities))
(define o3 (table-rename 'country 'sds cities))
(pretty-print o1)
(pretty-print o2)
(pretty-print o3)
