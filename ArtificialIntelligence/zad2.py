...
#   - if the word is legal and value calculated for previous word + squared the length of current one
...
max_states: dict[int, Node] = {
    0: empty_node}  # dict in which int is length of subtext, Node has maximized state for problem
...
if __name__ == "__main__":
    f = open("words_for_ai1.txt", "r", encoding="utf-8")
